...
<?php $__env->startSection('content'); ?>
	<div id="step1" ng-app="appAssessorStep1" ng-controller="assessorStep1Ctrl" ng-init="leadInfo.assessor = <?php echo e(Auth::user()->CODIGO); ?>">
...
<?php $__env->startSection('scriptsJs'); ?>
	<script type="text/javascript" src="<?php echo e(asset('js/assessorStep1.js')); ?>"></script>
<?php $__env->stopSection(); ?>
