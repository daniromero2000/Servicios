...
<?php $__env->startSection('content'); ?>
	<div id="step3" ng-app="appLibranzaStep3" ng-controller="step3Ctrl" ng-init="leadInfo.identificationNumber = <?php echo e($identificactionNumber); ?>" ng-cloak>
		...
		<div class="step3-containerForm">
			<div class="row resetRow">
				<div class="forms-descStep forms-descStepLibranza">
					...
					<img src="<?php echo e(asset('images/datosLaborales.png')); ?>" class="img-fluid forms-descImg" />
					...
					<div class="modal-body modalStepsBody" style="padding: 0">
						<div class="row resetRow">
							<div class="col-12 text-center containerLogoModalStep  containerLogoLibranza">
								<img src="<?php echo e(asset('images/logo_Creo.png')); ?>" alt="" class="img-fluid">
							</div>
						</div>
						<div class="row resetRow">
							<div class="col-12">
					...
					<div class="modal-body modalStepsBody" style="padding: 0">
						<div class="row resetRow">
							<div class="col-12 text-center containerLogoModalStep">
								<img src="<?php echo e(asset('images/logoOportuyaModalStep.png')); ?>" alt="" class="img-fluid">
							</div>
						</div>
						<div class="row resetRow">
							<div class="col-12">
...
<?php $__env->startSection('scriptsJs'); ?>
	<script type="text/javascript" src="<?php echo e(asset('js/libranzaStep3.js')); ?>"></script>
