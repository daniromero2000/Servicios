<?php $__env->startSection('title', 'Crédito libraza'); ?>
	...
	<div id="step1" ng-app="appLibranzaStep1" ng-controller="libranzaStep1Ctrl">
		...
		<div class="step1-containerForm">
			...
			<form role=form id="saveLeadOportuya" ng-submit="saveStep1()">
				...
				<?php echo NoCaptcha::display(['data-callback' => 'enableBtn']); ?>
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="text-center" style="padding: 50px;">
							<img src="<?php echo e(asset('images/gif-load.gif')); ?>" alt="">
...
<?php $__env->startSection('scriptsJs'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('js/libranzaStep1.js')); ?>"></script>
	<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.stepsLibranza', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>