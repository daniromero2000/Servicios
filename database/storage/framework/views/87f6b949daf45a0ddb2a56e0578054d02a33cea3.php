...
<?php $__env->startSection('content'); ?>
	<div id="step3" ng-app="appAdvacneStep3" ng-controller="advanceStep3Ctrl" ng-init="leadInfo.identificationNumber = <?php echo e($identificactionNumber); ?>" ng-cloak>
		<div class="row resetRow container-header-forms">
			<div class="form-container-logoHeader form-container-logoHeader-avances">
				<img src="<?php echo e(asset('images/logosAvancesNew.png')); ?>" class="img-fluid" alt="Oportuya" />
			</div>
						...
						<div class="row resetRow">
							<div class="col-12">
								<p class="textModal text-center">
									...
									<br>
									Tienes un cupo aprobado para avances en efectivo de:
								</p>
...
<?php $__env->startSection('scriptsJs'); ?>
	<script type="text/javascript" src="<?php echo e(asset('js/advanceStep3.js')); ?>"></script>
