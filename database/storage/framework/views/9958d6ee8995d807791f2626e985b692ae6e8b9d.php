...
<?php $__env->startSection('content'); ?>
	<div id="step2" ng-app="appLibranzaStep2" ng-controller="step2Ctrl" ng-init="leadInfo.identificationNumber = <?php echo e($identificactionNumber); ?>" ng-cloak>
		<div class="row resetRow container-header-forms  container-libranza-forms">
			<div class="form-container-logoHeader form-container-logoLibranza">
				<img src="<?php echo e(asset('images/logo_Creo.png')); ?>" class="img-fluid libranzaSteplogo" alt="Oportuya" />
			</div>
		...
		<div class="row resetRow">
			...
			<div class="col-12">
				<div class="step3-containerForm">
					<img src="<?php echo e(asset('images/iconoStartProgreso2.png')); ?>" alt="" class="img-fluid imgStartProgress">
					<div class="progreso">
						<div class="barra_vacia barra_vacia_libranza" style="width: 33.333333%;"></div>
					...
					<img src="<?php echo e(asset('images/iconoEndProgreso2.png')); ?>" alt="" class="img-fluid imgEndProgress">
				</div>
			</div>
		</div>
		<div class="step2-containerForm">
			<div class="row resetRow">
				<div class="forms-descStep forms-descStepLibranza">
					...
					<img src="<?php echo e(asset('images/datosPersonales2.png')); ?>" class="img-fluid forms-descImg" />
			...
			<form id="step2Form" ng-submit="saveStep2()">
				...
				<div class="row resetRow" ng-if="leadInfo.occupation == 'PENSIONADO'">
					...
					<div class="col-sm-12 col-md-4 form-group">
						<label for="cityExpedition">Nacionalidad* </label>
					    <select class="form-control inputsSteps inputSelect" id="nationality" ng-model="leadInfo.nationality" ng-options="country.id as country.name for country in countries" required></select>
					</div>
				</div>
				<div class="row resetRow">
					<div class="col-sm-12 col-md-4 form-group">
					...
					<div class="col-sm-12 col-md-4 form-group">
						...
						<input type="text" ng-model="leadInfo.housingTime" class="form-control inputsSteps inputText" id="housingTime" validation-pattern="number" required="" />
					</div>
				...
				<div class="row resetRow">
					...
					<div class="col-sm-12 col-md-6 form-group">
						...
						<input type="text" class="form-control inputsSteps inputText" ng-model="leadInfo.stratum" validation-pattern="number" id="stratum" />
					</div>
				</div>
				<div class="row resetRow">
				...
				<div class="row resetRow">
					<div class="col-12 text-center">
						<button type="submit" class="btn btn-primary btnStep btnStepLibranza">Continuar</button>
					</div>
				</div>
			</form>
		</div>
...
<?php $__env->startSection('scriptsJs'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('js/libranzaStep2.js')); ?>"></script>
