...
Route::group(['prefix' => '/assessor/'], function () {
    ...
    Route::group(['prefix' => '/api/'], function () {
        ...
        Route::get('decisionCreditCard/{lastName}/{identificationNumber}/{quotaApprovedProduct}/{quotaApprovedAdvance}/{dateExpIdentification}/{nom_refper}/{dir_refper}/{bar_refper}/{tel_refper}/{ciu_refper}/{nom_refpe2}/{dir_refpe2}/{bar_refpe2}/{tel_refpe2}/{ciu_refpe2}/{nom_reffam}/{dir_reffam}/{bar_reffam}/{tel_reffam}/{parentesco}/{nom_reffa2}/{dir_reffa2}/{bar_reffa2}/{tel_reffa2}/{parentesc2}/{con_cli1}/{con_cli2}/{con_cli3}/{con_cli4}/{edit_rfcli}/{edit_rfcl2}/{fuenteFallo}', 'Admin\assessorsController@decisionCreditCard');
        Route::get('decisionTraditionalCredit/{identificationNumber}/{nom_refper}/{dir_refper}/{bar_refper}/{tel_refper}/{ciu_refper}/{nom_refpe2}/{dir_refpe2}/{bar_refpe2}/{tel_refpe2}/{ciu_refpe2}/{nom_reffam}/{dir_reffam}/{bar_reffam}/{tel_reffam}/{parentesco}/{nom_reffa2}/{dir_reffa2}/{bar_reffa2}/{tel_reffa2}/{parentesc2}/{con_cli1}/{con_cli2}/{con_cli3}/{con_cli4}/{edit_rfcli}/{edit_rfcl2}/', 'Admin\assessorsController@decisionTraditionalCredit');
