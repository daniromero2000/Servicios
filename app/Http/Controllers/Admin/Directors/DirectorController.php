...
class DirectorController extends Controller
{
  ...
  public function dashboard(Request $request)
  {
    ...
    $factoryRequestsTotal   = $this->factoryInterface->getDirectorZonaFactoryTotal($from, $to, $director);
    ...
    if (request()->has('from')) {
      ...
      $factoryRequestsTotal = $this->factoryInterface->getDirectorZonaFactoryTotal(request()->input('from'), request()->input('to'), $director);
