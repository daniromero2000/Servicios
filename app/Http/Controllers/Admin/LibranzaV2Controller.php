...
class LibranzaV2Controller extends Controller
{
	...
	public function step1()
	{
		...
		return view('libranza.step1', [
			'digitalAnalyst' => $digitalAnalyst[0],
			'cities' => array_sort($cities, 'label', SORT_DESC)
		]);
	}
	...
	{
		return response()->json([$this->decrypt($string)]);
	}

	public function step2($string)
	{
		return view('libranza.step2', [
