...
namespace App\Http\Controllers\Admin\FactoryRequestsComments;

use App\Entities\FactoryRequestComments\Repositories\Interfaces\FactoryRequestCommentRepositoryInterface;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class FactoryRequestsCommentController extends Controller
{
    private $commentInterface;

    public function __construct(
        FactoryRequestCommentRepositoryInterface $commentRepositoryInterface
    ) {
