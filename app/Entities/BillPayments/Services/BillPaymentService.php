        ...
        return [
            'data' => [
                ...
                'searchInputs'       => [
                    ...
                    ['label' => 'Sucursal', 'type' => 'select', 'options' =>  $subsidiaries, 'name' => 'subsidiary_id', 'option' => 'code', 'value' => 'id']
                ],
                'inputs' => [
        ...
        return [
            'data' => [
                ...
                'searchInputs'       => [
                    ['label' => 'Buscar', 'type' => 'text', 'name' => 'q'],
                    ['label' => 'Dia de pago', 'type' => 'number', 'name' => 'payment_deadline'],
                    ['label' => 'Sucursal', 'type' => 'select', 'options' => collect($subsidiaries), 'name' => 'subsidiary_id', 'option' => 'code', 'value' => 'id']
                ],
                'inputs' => [
                    ['label' => 'Referencia de pago', 'type' => 'text', 'name' => 'payment_reference'],
                    ['label' => 'Dia limite de pago', 'type' => 'number', 'name' => 'payment_deadline'],
