...
@section('content')
	<div id="step2" ng-app="appLibranzaStep2" ng-controller="step2Ctrl" ng-init="leadInfo.identificationNumber = {{$identificactionNumber}}" ng-cloak>
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/Libranzastep2.js') }}"></script>
