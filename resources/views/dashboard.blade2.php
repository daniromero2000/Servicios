	...
	<nav class="navBarButton navbar navbar-expand-lg navbar-light bg-light">
		...
		<div id="dashboardContent" class="tab-content">        
			...
			<div id="mainDashboard" role="tabpanel" class="tab-pane tab-content"> 
				@include('dashboard.mainDashboard')
			</div>
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/appDashboard/app.js') }}"></script>
	<script type="text/javascript" src="{{ asset('js/appDashboard/controllers/dashboardModulesControllers.js') }}"></script>
@endsection