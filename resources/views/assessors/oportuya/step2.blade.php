...
@section('content')
	<div id="step2" ng-app="appAssessorStep2" ng-controller="assessorStep2Ctrl" ng-init="leadInfo.identificationNumber = {{$identificactionNumber}}" ng-cloak>
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/assessorStep2.js') }}"></script>
