...
@section('content')
	<div id="step3" ng-app="appAssessorStep3" ng-controller="assessorStep3Ctrl" ng-init="leadInfo.identificationNumber = {{$identificactionNumber}}" ng-cloak>
		<div class="row resetRow container-header-forms">
			...
			<div class="col-12 conatiner-logoImg">
				...
				<span class="steps-textStep"><strong>Solicitud de Crédito Paso 3</strong></span>
			</div>
		</div>
		...
		<div class="step3-containerForm">
			...
			<div>
				<form ng-submit="saveStep3()" id="formEmpleado" ng-if="leadInfo.occupation == 'EMPLEADO' || leadInfo.occupation == 'SOLDADO-MILITAR-POLICÍA'">
					{{ csrf_field() }}
					<div class="row resetRow">
			...
			<div>
				<form ng-submit="saveStep3()" id="formIdependiente" ng-if="leadInfo.occupation == 'INDEPENDIENTE CERTIFICADO' || leadInfo.occupation == 'INDEPENDIENTE CERTIFICADO' || leadInfo.occupation == 'RENTISTA'">
					{{ csrf_field() }}
					<div class="row resetRow">
						<div class="col-sm-12 col-md-6 form-group">
			...
			<div>
				<form ng-submit="saveStep3()" id="formPensionado" ng-if="leadInfo.occupation == 'PENSIONADO'">
					{{ csrf_field() }}
					<div class="row resetRow">
						<div class="col-sm-12 col-md-6 form-group">
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/assessorStep3.js') }}"></script>
