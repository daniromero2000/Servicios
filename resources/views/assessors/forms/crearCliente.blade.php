...
<div class="container" ng-app="asessorVentaContadoApp" ng-controller="asessorVentaContadoCtrl" ng-cloak>
                        ...
                        <div class="col-12 type-client">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-3">
                                    ...
                                    <select class="inputs form-control select2bs4" ng-model="lead.TIPO_DOC" id="tipodoc" ng-options="type.value as type.label for type in typesDocuments"></select>
                                </div>
                                <div class="col-12 col-md-3">
                            ...
                            <div class="row form-group">
                                <div class="col-12 col-md-4">
                                    ...
                                    <select class="inputs form-control select2bs4" ng-model="lead.CIUD_UBI" id="ciud_ubi" ng-options="city.value as city.label for city in citiesUbi" ng-required="true"></select>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <select class="inputs form-control select2bs4" ng-model="lead.ACTIVIDAD" id="actividad" ng-options="actividad.value as actividad.label for actividad in occupations"></select>
                                </div>
                        ...
                        <div class="col-12 type-client">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select ng-disabled="true" class="inputs form-control" ng-model="lead.CIUD_UBI" id="ciud_ubi2" ng-options="city.value as city.label for city in citiesUbi"></select>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <label class="ventaContado-label labels" for="tipoCont">Tipo de
                                            contrato*</label>
                                        <select class="inputs form-control select2bs4" ng-model="lead.TIPO_CONT" id="tipoCont" ng-options="typeContract.value as typeContract.label for typeContract in typesContracts"></select>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="labels" for="salario">Salario*</label>
                                        <input class="inputs" id="salario" ng-currency fraction="0" type="text" ng-model="lead.SUELDO" required />
                                        <div class="alert alert-danger" role="alert" ng-show="showAlertSalary" style="margin-top: 10px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4" ng-show="lead.ACTIVIDAD == 'INDEPENDIENTE CERTIFICADO'">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" data-inputmask-alias="datetime" ng-model="lead.FEC_CONST" id="FEC_CONST" ng-disabled="true" required data-inputmask-inputformat="yyyy-mm" data-mask>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4" ng-show="lead.ACTIVIDAD == 'NO CERTIFICADO' || lead.ACTIVIDAD == 'RENTISTA'">
                            ...
                            <div ng-if="lead.ACTIVIDAD == 'PENSIONADO'">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        ...
                                        <select class="form-control inputs select2bs4" ng-model="lead.BANCOP" id="BANCOP" ng-options="bank.value as bank.label for bank in banks" required></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="inputs form-control" ng-model="lead.TEL_REFPER" id="TEL_REFPER" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="inputs form-control" ng-model="lead.TEL_REFPE2" id="TEL_REFPE2" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="inputs form-control" ng-model="lead.TEL_REFFAM" id="TEL_REFFAM" required />
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="PARENTESCO" class="labels">Parentesco*</label>
                                                    <select id="PARENTESCO" class="inputs form-control" ng-model="lead.PARENTESCO" ng-options="kinship.TIPO as kinship.TIPO for kinship in kinships" required></select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="inputs form-control" ng-model="lead.TEL_REFFA2" id="TEL_REFFA2" required />
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <label for="PARENTESC2" class="labels">Parentesco*</label>
                                                    <select id="PARENTESC2" class="inputs form-control" ng-model="lead.PARENTESC2" ng-options="kinship.TIPO as kinship.TIPO for kinship in kinships" required></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade modalThankYouPage-asessors" id="showWarningErrorData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
