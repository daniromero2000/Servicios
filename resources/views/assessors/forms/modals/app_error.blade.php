                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="error-content p-3">
                            <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! El aplicativo ha
                                presentado un
                                error.</h3>
                            <div>
                                <p style="margin: 0px;">
                                    Puedes comunicate con el area de desarrollo y darle este número de error
                                    <strong style="font-size:20px; color: #1b8acc">@{{ numError }}</strong>.
                                </p>
