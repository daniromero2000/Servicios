    ...
    <div class="card-header">
        <div class="row">
            <div class="col-12 text-right">
                <a href="#myModal" data-toggle="modal" data-target="#leadPricemodal" <i
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <i class="fas fa-trash-alt cursor" data-toggle="modal"
                            data-target="#deleteLead{{$leadPrice->id}}"></i>
                    </td>
                </tr>
                                ...
                                <div class="container">
                                    <div class="row resetRow ">
                                        <div class="col-12 form-group">
                                            <form action="{{ route('leadPrices.update', $leadPrice->id ) }}"
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-sm-12 form-group no-padding-right">
                                                            <label for="lead_product_id">Producto <span
                                                                    class="text-danger">*</span></label>
                                                            <select id="lead_product_id" name="lead_product_id"
                                                                class="form-control">
                                                                @if ($lead_products)
                                                    ...
                                                    <input name="lead_id" id="lead_id" hidden
                                                        value="{{ $digitalChannelLead->id }}">
                                                    <div class="form-group">
                                                        <label for="description">Descripción<span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <input type="text" name="description"
                                                                validation-pattern="text" id="description"
                                                                placeholder="Descripcioón" class="form-control"
                                                                value="{{ $leadPrice->description }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="lead_price">Precio <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <input type="number" name="lead_price"
                                                                validation-pattern="text" id="lead_price"
                                                                placeholder="Precio" class="form-control"
                                                                value="{{ $leadPrice->lead_price }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="lead_price_status_id">Estado <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <select id="lead_price_status_id"
                                                                name="lead_price_status_id" class="form-control">
                                                                @if ($leadPriceStatus)
                                                                @foreach($leadPriceStatus as $leadPriceState)
                                                                <option @if ($leadPrice->leadPriceStatus ==
                                                                    $leadPriceState)
                                                                    selected="selected" @endif
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form style="display:inline-block"
                                action="{{ route('leadPrices.destroy', $leadPrice->id) }}" method="post"
