                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                            {{-- <li class="nav-item">
                                <a class="nav-link " id="generals-tab" data-toggle="pill" href="#generals" role="tab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="advancedUnit-tab" data-toggle="pill" href="#advancedUnit"
                                    role="tab" aria-controls="advancedUnit" aria-selected="false">Unidad Avanzada</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="juridicales-tab" data-toggle="pill" href="#juridicales"
                                    role="tab" aria-controls="juridicales" aria-selected="false">Juridica</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <div class="tab-pane fade " id="generals" role="tabpanel" aria-labelledby="generals-tab">
                                <div class="row mt-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <span class="info-box-number">
                                                                ${{number_format($leadpriceTotal)}}</span>
                                                        </div>
                                                        <div class="col-6">
                                                            <span class="info-box-text text-right"><a
                                                                    href="/Administrator/digitalchannelleads"
                            ...
                            <div class="tab-pane fade" id="advancedUnit" role="tabpanel"
                                aria-labelledby="advancedUnit-tab">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <div class="col-12 col-sm-12">
                                            <div class="row d-flex justify-content-center">
                            ...
                            <div class="tab-pane fade" id="juridicales" role="tabpanel"
                                aria-labelledby="juridicales-tab">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <div class="col-12 col-sm-12">
                                            <div class="row d-flex justify-content-center">
