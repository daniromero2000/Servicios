	...
	<div class="row resetRow">
		<div class="col-12 step2-containTitle">
			<h2 class="text-center step2-titleAnalista"><strong>Hola!</strong> soy {{ $digitalAnalyst['name'] }} tu
				analista digital</h2>
			<p class="text-center step2-textAnalista">En este momento te encuentras haciendo tu solicitud de avance, por
				favor diligencia <br> todos los datos para que tu aprobación sea más fácil</p>
			<h3 class="forms-text-analyst forms-text-analyst-avances text-center">Solo te tomará unos minutos solicitar
				tu Avance</h3>
		</div>
		<div class="col-12">
		...
		<form role=form id="saveLeadOportuya" ng-submit="confirmnumCel()">
			<div class="row resetRow">
				<div class="col-12 col-sm-4 form-group">
					...
					<select class="form-control inputsSteps inputSelect" ng-model="leadInfo.typeDocument"
						id="typeDocument" required="" ng-options="type.value as type.label for type in typesDocuments">
					</select>
				</div>
				<div class="col-12 col-sm-4 form-group">
			...
			<div class="row resetRow">
				<div class="col-sm-12 col-md-6 form-group">
					...
					<input type="text" ng-model="leadInfo.email" ng-blur="validateEmail()" validation-pattern="email"
						class="form-control inputsSteps inputText" id="email" required="true" />
				</div>
				<div class="col-sm-12 col-md-6 form-group">
			...
			<div class="row resetRow">
				<div class="col-sm-12 col-md-6">
					<div class="form-group">
						...
						<input ng-show="leadInfo.CEL_VAL" ng-model="telephone" ng-disabled="true" type="text" readonly
							class="form-control inputsSteps inputText">
					</div>
					<div class="alert alert-warning" ng-show="leadInfo.CEL_VAL">
						Si deseas cambiar el número de celular, por favor comunícate con la línea de atención al cliente
						01 8000 17787
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<label for="occupation">Ocupación*</label>
					<select class="form-control inputsSteps inputSelect" ng-model="leadInfo.occupation" required=""
			...
			<div class="form-group">
				...
				<label for="termsAndConditions" style="font-size: 13px; font-style: italic;">
					Aceptar <a href="/Terminos-y-condiciones" class="linkTermAndCondition" target="_blank">términos y
						condiciones</a> y <a href="/Proteccion-de-datos-personales" class="linkTermAndCondition"
				...
				<div class="modal-body" style="padding: 10px">
					<div class="row">
						<div class="col-12 form-group">
							...
							<input ng-hide="leadInfo.CEL_VAL" type="text" ng-model="leadInfo.telephone"
								validation-pattern="telephone" class="form-control inputsSteps inputText" id="telephone"
								required="true" ng-disabled="leadInfo.CEL_VAL" />
