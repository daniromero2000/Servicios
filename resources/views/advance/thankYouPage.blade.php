...
<script>
	window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);} gtag('js',new Date());gtag('config','AW-781153823',{'page_title':'Avance ThankYouPage','page_path':'/AD_gracias_FRM'});
</script>
@section('content')
	<div class="row resetRow">
		<div class="col-12 text-center resetCol thankContainer">
			...
			<div class="dialogThakPage">	
				...
				<p>	Gracias por contactarte con nosotros, un asesor de Avances se comunicará contigo para darte más información.</p>
			</div>
		</div>
	</div>
@endsection()