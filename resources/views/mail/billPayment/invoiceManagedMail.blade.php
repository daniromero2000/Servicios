                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top"
                                                                                                                        align="left"
                                                                                                                        name="tblCell"
                                                                                                                        style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;"
                                                                                                                        class="tblCell">
                                                                                                                        <div
                                                                                                                            style="line-height: 150%; text-align: center; padding: 0px 25px;">
                                                                                                                            <span
                                                                                                                                style="font-size: 16px; color: #ffffff; line-height: 150%;">La siguiente factura esta en estado <b>Gestionado</b> y no se ha confirmado pago.</span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
