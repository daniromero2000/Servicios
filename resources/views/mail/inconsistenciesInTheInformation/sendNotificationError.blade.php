                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top"
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <span
                                                                                                                                style="font-size: 18px; color: #ffffff; line-height: 125%;">
                                                                                                                                <em><strong>La información suministrada a la pagina servicios oportunidades es incorrecta, a continuación se mostrara la razón del error 
                                                                                                                                </strong></em></span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                    ...
                                                                                                                    <td style="border-radius: 0px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 20px 40px; font-weight: bold; background-color: rgb(243, 156, 18);"
                                                                                                                        ...
                                                                                                                        <span
                                                                                                                            ...
                                                                                                                            <a style="color:#FFFFFF;text-decoration:none;"
                                                                                                                                target="_blank">{{$data['message']}}</a></span>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td class="text-services"
                                                                                                        style="text-align: center;">
                                                                                                           <p
                                                                                                            ...
                                                                                                            Dato ingresado: {{$data['error']['dataCustomer']}}
                                                                                                           <b> </b>
                                                                                                        </p>
                                                                                                           <p
                                                                                                            style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;font-weight: 400;color: rgb(56, 56, 56);">
                                                                                                            Dato real: {{$data['error']['dataRegistraduria']}}
                                                                                                           <b> </b>
                                                                                                        </p>
                                                                                                        <p
                                                                                                            style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;font-weight: 400;color: rgb(56, 56, 56);">
