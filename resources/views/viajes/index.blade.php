...
@section('metaTags')
	...
	<meta property="og:image" content="{{ asset('images/ViajesPortadaOg.png') }}" />
		...
		<div class="modal-content">
			<div class="modal-body modalFormulario-body">
				<div class="modal-containerFormulario">
					...
					<form role=form method="POST" id="saveLeadViajes" action="{{ route('viajes.store') }}">
						{{ csrf_field() }}
	...
	<div class="row plansContent">
		...
		@foreach($plans as $key => $plan)
			...
			<section>
				...
				<p class="planButton">
					<a href="https://api.whatsapp.com/send?phone=573105216830" target="_blank">
						{{$plan['textButton']}} <span>  <i class="fab fa-whatsapp"></i></span>
					</a>
				</p>
			</section>
		</div>
...
<div id="travelOffers">
	<div class="row">
		<div class="travelOffersIcon col-sm-4 col-4 offset-md-3 col-md-2 travelOffersImg">
			<img src="{{asset('images/viajesMailIcon.png')}}" class="img-fluid">
		</div>
