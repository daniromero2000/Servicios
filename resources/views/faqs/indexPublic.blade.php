  ...
  <div id="accordion">
    ...
    <div class="card cardFQA">
      <div class="card-header card-headerFQA" id="heading{{$pregunta->id}}">
        <button class="btn btn-default ourStores-titleStore btn-FAQ cardItem{{$key}}" data-toggle="collapse"
          data-target="#collapse{{$pregunta->id}}" aria-expanded="false" aria-controls="collapse{{$pregunta->id}}">
      ...
      <div id="collapse{{$pregunta->id}}" class="collapse @if($show) @php echo 'show'; $show=false @endphp @endif"
