                      ...
                      <div class="row container-form">
                          ...
                          <div class="row">
                            <div class="col-12 col-md-3">
                              ...
                              <select class="inputs form-control select2bs4" ng-model="lead.TIPO_DOC" id="tipodoc"
                                ng-options="type.value as type.label for type in typesDocuments" required></select>
                            </div>
                            <div class="col-12 col-md-3">
                              <label class="labels" for="CEDULA">Número de documento*</label>
                              <input class="inputs" validation-pattern="IdentificationNumber" ng-blur="getInfoLead()"
                        ...
                        <div class="col-12 text-center mt-4">
                          <div class="form-group" style="margin-bottom: 5px;">
                            <input type="checkbox" ng-model="lead.termsAndConditions" name="termsAndConditions"
                              id="termsAndConditions" required="">
                            <label for="termsAndConditions" class="termAndConditions">
                              Aceptar <a href="/Terminos-y-condiciones" class="linkTermAndCondition" target="_blank"
                                style="color: #167efa;">términos y condiciones</a> y
                              <a href="/Proteccion-de-datos-personales" class="linkTermAndCondition" target="_blank"
