    ...
    <div class="mx-auto" style="max-width: 1450px;">
        ...
        <div ng-app="appQuotations" ng-controller="quotationsController">
            <div class="row mx-0 p-3">
                                            ...
                                            <div class="row mx-0 container-form">
                                                ...
                                                <div class="col-12 type-client">
                                                    <div class="forms-descStep forms-descStep-avances">
                                                        ...
                                                        <span class="forms-descText">Ingresa los datos principales para hacer la cotización</span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-3">
                                                            ...
                                                            <select class="inputs form-control select2bs4" ng-model="lead.TIPO_DOC" id="tipodoc" ng-options="type.value as type.label for type in typesDocuments" required></select>
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                            <label class="labels" for="CEDULA">Número de documento*</label>
                                                            <input class="inputs" validation-pattern="IdentificationNumber" ng-blur="getInfoLead()" type="text" ng-model="lead.CEDULA" id="CEDULA" required />
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                        ...
                                                        <div class="col-12 col-md-3">
                                                            ...
                                                            <div ng-show="lead.CEL_VAL">
                                                                <label class="ventaContado-label">Celular*</label>
                                                                <input class="inputs" ng-model="CELULAR" readonly ng-disabled="true" required />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                ...
                                                <div class="col-12 text-center mt-4">
                                                    <div class="form-group" style="margin-bottom: 5px;">
                                                        <input type="checkbox" ng-model="lead.termsAndConditions" name="termsAndConditions" id="termsAndConditions" required="">
                                                        <label for="termsAndConditions" class="termAndConditions">
                                                            Aceptar <a href="/Terminos-y-condiciones" class="linkTermAndCondition" target="_blank" style="color: #167efa;">términos y condiciones</a> y
                                                            <a href="/Proteccion-de-datos-personales" class="linkTermAndCondition" target="_blank" style="color: #167efa;">política de tratamiento de
                                                                datos</a>
                                                        </label>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-12" ng-show="step == 2">
                                    <div class="col-12 type-client">
                                        <div class="forms-descStep forms-descStep-avances">
                                            ...
                                            <span class="forms-descText">Ingresa los datos necesarios para el proceso</span>
                                            <img src="{{ asset('images/datosPersonales.png') }}" class="img-fluid forms-descImg">
                                    ...
                                    <div class="card card-default">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="ml-auto my-auto">
                                                <button type="button" ng-if="quotations[0]" ng-click="createLiquidator()" class="btn btn-primary btn-sm">Crear
                                                    Cotización</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade hide" data-backdrop="static" data-keyboard="false" id="congratulations" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="modal-body " style="padding: 0">
                                ...
                                <div class="row mt-2 resetRow">
                                    <div class="col-12 text-center">
                                        <img src="https://image.flaticon.com/icons/svg/845/845646.svg" alt="" style=" width: 11%;margin-top: 1%;margin-right: 0%;margin-bottom: 1%;" />
                                        <p class="">
