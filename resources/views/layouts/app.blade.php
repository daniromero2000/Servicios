...
<html>
	<head>
		...
		<link href="{{ asset('public/editor/contentbuilder/contentbuilder.css')}}" rel="stylesheet" type="text/css" /> 
		<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
		<script type="text/javascript" src="{{asset('public/js/validateV2.js')}}"></script>
			...
			<div class="row resetRow">
				<div class="col-12 col-sm-12 col-lg-6 resetCol headerImage">
					<div class="header-containerLogo">
						<a href="/">
							<img src="{{ asset('public/images/opottunidadesServiciosFinancierosLogo.png')}}" title="Oportunidades Servicios Financieros" class="img-fluid">
						</a>
					</div>
				</div>
						...
						<div class="collapse navbar-collapse header-containerItems" id="navbarNavAltMarkup">
							<div class="navbar-nav header-menu @php echo $barraOportuya @endphp">
								...
								<a class="nav-item nav-link header-item header-item2 @php echo $activeMotos @endphp" href="/motos">
									<img src="{{ asset('public/images/sombraMenu.png') }}" alt="Sombra Menú" class="img-fluid imgSombraMenu"> <span class="header-textoItem">Crédito motos</span>
								</a>
								<a class="nav-item nav-link header-item header-item3 @php echo $activeLibranza @endphp " href="/libranza"> 
									<img src="{{ asset('public/images/sombraMenu.png') }}" alt="Sombra Menú" class="img-fluid imgSombraMenu"> <span class="header-textoItem">Crédito libranza</span>
								</a>
								<a class="nav-item nav-link header-item header-item4 @php echo $activeSeguros @endphp " href="/seguros">
									<img src="{{ asset('public/images/sombraMenu.png') }}" alt="Sombra Menú" class="img-fluid imgSombraMenu"> <span class="header-textoItem">Seguros</span>
								</a>
								<a class="nav-item nav-link header-item header-item5 @php echo $activeViajes @endphp " href="/viajes">
									<img src="{{ asset('public/images/sombraMenu.png') }}" alt="Sombra Menú" class="img-fluid imgSombraMenu"> <span class="header-textoItem">Viajes</span>
								</a>
							</div>
						</div>
					</nav>
			...
			<div class="row resetRow">
				<div class="col-12 col-md-12 col-lg-3 resetCol footer-containMenu">
					<div class="footer-contianerLogo">
						<img src="{{ asset('public/images/footer-oportunidadesServiciosFinancierosLogo.png')}}" title="Oportunidades Servicios Financieros" class="img-fluid">
					</div>
					<div class="footer-contianerTelefonos">
						<img src="{{ asset('public/images/footer-telefonoIcon.png')}}" alt="Línea Nacional" class="img-fluid footer-imgNosotros" />
				...
				<div class="col-12 col-md-12 col-lg-3 resetCol">
					<div class="footer-containerNewsletter">
						...
						<span class="footer-menuText">SÍGUENOS:</span> <a href="#"><img src="{{ asset('public/images/footer-facebookIcon.png')}}" alt="Facebook Oportunidades Servicios Financieros" class="img-fluid"></a>
					</div>
				</div>
			</div>

		</div>
		<script src="{{ asset('public/editor/contentbuilder/jquery-ui.min.js')}}" type="text/javascript"></script>
		<script src="{{ asset('public/editor/contentbuilder/contentbuilder.js')}}" type="text/javascript"></script>
		<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.7.5/angular.min.js"></script>
		<script type="text/javascript" src="{{ asset('public/js/libranza.js') }}"></script>
