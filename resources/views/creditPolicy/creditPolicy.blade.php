<nav>
    ...
    @else
        ...
        <a class="nav-item nav-link cursor" id="nav-general-tab" ng-class="{ 'active': tabs == 2 }" ng-click="tabs = 2"
            data-toggle="tab" role="tab" aria-controls="nav-general">Simular Individual</a>
        <a class="nav-item nav-link cursor"
            id="nav-general-tab" ng-class="{ 'active': tabs == 3 }" ng-click="tabs = 3" data-toggle="tab" role="tab"
            aria-controls="nav-general">Simular Masivo</a>
    @endif
</nav>
        ...
        <div ng-show="showResp">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <p>
                        <label for="">Tiempo Labor: </label><span ng-if="infoLead.TIEMPO_LABOR == 1">Si cumple</span>
