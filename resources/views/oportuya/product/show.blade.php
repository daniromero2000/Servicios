...
<div class="my-3 padding-reset" style="max-width: 1300px;margin: 0px auto; margin-bottom: 5% !important;">
    <div class="row mr-0 justify-content-center">
        ...
        <div class="col-lg-7 mt-3 px-0" style="box-shadow: 0 .4rem 1rem rgba(0,0,0,0.05)!important;border-radius: 21px;">
                    ...
                    <div class="row mx-auto">
                        ...
                        <div class="container">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div @if ($image[1]==0) class="carousel-item active" @else class="carousel-item" @endif data-slide-number="{{$image[1]}}">
                                    <img class="img-principal-carousel lazy" alt="{{$image[0]}}" data-src="{{asset('storage/'.$image[0])}}" src="{{ asset('images/blank.jpg')}}" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                                </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row mx-0">
                            ...
                            <div id="carousel-selector-{{$image[1]}}" @if ($image[1]==0) class="thumb col-4 col-sm-3 px-0 py-2 selected" @else class="thumb col-4 col-sm-3 px-0 py-2" @endif data-target="#myCarousel" data-slide-to="{{$image[1]}}">
                                <img data-src="{{asset('storage/'.$image[0])}}" src="{{ asset('images/blank.jpg')}}" class="img-fluid lazy" alt="{{$image[0]}}">
                            </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <div class="col-lg-5 container-deal">
        <div class="row mx-0 container-steps-products justify-content-center text-center">
            <div class="col-4">
                <div>
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_Envio.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="envio" class="img-step-product lazy">
                </div>
            ...
            <div class="col-4">
                <div>
                    <img src="{{ asset('images/blank.jpg')}}" data-src="{{ asset('images/Front/OportuyaCustomers/iconos/Icono_Credit.jpg') }}" alt="credito" class="img-step-product lazy ">
                </div>
                <div class="mt-2 text-step-product">
            ...
            <div class="col-4">
                <div>
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_Store.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="tienda" class="img-step-product lazy">
                </div>
                <div class="mt-2 text-step-product">
        ...
        <div class="row">
            <div class="card border-0 container-deal-product">
                <div class="card-body pt-0 pr-4 pl-4">
                    ...
                    <div class="relative">
                        <img data-src="{{ asset('images/Front/OportuyaCustomers/Fotos Productos/TV LG 43/Tarjeta.jpg')}}" src="{{ asset('images/blank.jpg')}}" class="img-card-deal-product lazy">
                        ...
                        <div class="container-dues-deal-product">
                            ...
                            <a href="/step1?productId={{ $product->id}}" class="btn card-products-button btn-primary" style="margin-left: 15px;">Solicitar
                                aqui</a>
                        </div>
                    </div>
                    <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <img alt="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_WhatsApp.png')}}" data-src="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_WhatsApp.png')}}" src="{{ asset('images/blank.jpg')}}" class="first-img-contact-deal-product lazy">
                        <img data-src="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_Tell.png')}}" src="{{ asset('images/blank.jpg')}}" alt="{{ asset('images/Front/OportuyaCustomers/iconos/Icon_Tell.png')}}" class="second-img-contact-deal-product lazy">
                        ...
                        <div class="text-center">
                            <a href="https://api.whatsapp.com/send?phone=573115195753&text=Quiero más información sobre el producto {{ $product->reference}} y el crédito en electrodomésticos." target="_blank" class="button-contact-deal-product" type="button">Whatsapp
                                Directo</a>
                        </div>
                    </div>
...
<div style="max-width: 1300px;margin: 0px auto;margin-bottom: 5%;">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link link-nav-description active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Descripción del producto</a>
        </li>
        <li class="nav-item">
            <a class="nav-link link-nav-description" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Especificaciones</a>
        </li>
    </ul>
    <div class="tab-content padding-responsive" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="card border-0 padding-responsive padding-reset" style="box-shadow: 0 .4rem 1rem rgba(0,0,0,0.08)!important;">
                <div class="card-body padding-responsive">
                    <div class="row justify-content-center ">
                        <div class="col-12 col-sm-6  p-0">
                            <img class="img-fluid img-description-product img-responsive lazy" src="{{ asset('images/blank.jpg')}}" data-src="{{asset('storage/'.$product->description_image1)}}">
                        </div>
                        <div class="col-12 col-sm-6  p-0">
                            <img class="img-fluid img-description-product img-responsive lazy" data-src="{{asset('storage/'.$product->description_image2)}}" src="{{ asset('images/blank.jpg')}}">
                        </div>
                        <div class="col-12 col-sm-6  p-0">
                            <img class="img-fluid img-description-product img-responsive lazy" data-src="{{asset('storage/'.$product->description_image3)}}" src="{{ asset('images/blank.jpg')}}">
                        </div>
                        <div class="col-12 col-sm-6  p-0">
                            <img class="img-fluid img-description-product img-responsive lazy" data-src="{{asset('storage/'.$product->description_image4)}}" src="{{ asset('images/blank.jpg')}}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="card border-0 padding-reset padding-responsive" style="box-shadow: 0 .4rem 1rem rgba(0,0,0,0.08)!important;">
                <div class="card-body padding-responsive">
                    <a data-toggle="modal" data-target="#exampleModal">
                        <img class="img-fluid lazy" data-src="{{asset('storage/'.$product->specification_image)}}" src="{{ asset('images/blank.jpg')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
...
<div class="modal fade bd-example-modal-xl" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style=" margin-left: auto;margin-right: 9px;margin-top: 5px; ">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-sm-8 col-10 ">
                <div class="card text-center step-cards-product  border-0 mx-auto">
                    <img alt="" data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/1.jpg') }}" src="{{ asset('images/blank.jpg')}}" class="number-img-step-cards lazy">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/Image_1.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="icon-step-cards lazy">
            ...
            <div class="col-md-6 col-sm-8 col-10 ">
                <div class="card text-center step-cards-product  border-0 mx-auto">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/2.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="number-img-step-cards lazy">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/Image_2.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="icon-step-cards lazy">
                    <div class="card-body card-body-view">
            ...
            <div class="col-md-6 col-sm-8 col-10 ">
                <div class="card text-center step-cards-product  border-0 mx-auto">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/3.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="number-img-step-cards lazy">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/Image_3.jpg') }}" src="{{ asset('images/blank.jpg')}}" class="icon-step-cards lazy">
                    <div class="card-body card-body-view">
            ...
            <div class="col-md-6 col-sm-8 col-10 ">
                <div class="card text-center step-cards-product  border-0 mx-auto">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/4.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="number-img-step-cards lazy">
                    <img data-src="{{ asset('images/Front/OportuyaCustomers/PaginaInterna/Snipet/Image_4.jpg') }}" src="{{ asset('images/blank.jpg')}}" alt="" class="icon-step-cards lazy">
                    <div class="card-body card-body-view">
