	...
	<div id="step1" ng-app="appStep1" ng-controller="step1Ctrl" ng-init="leadInfo.productId = 0">
		...
		<div class="row resetRow container-header-forms">
			...
			<div class="col-12 conatiner-logoImg">
				<img src="/{{ $digitalAnalyst['img'] }}" alt="{{ $digitalAnalyst['name'] }}"
					class="img-fluid steps-imgAnalista" />
		...
		<div class="row resetRow">
			<div class="col-12 step2-containTitle">
				<h2 class="text-center step2-titleAnalista"><strong>Hola!</strong> soy {{ $digitalAnalyst['name'] }} tu
					analista digital</h2>
				<p class="text-center step2-textAnalista">En este momento te encuentras haciendo tu solicitud de
					crédito, por favor diligencia <br> todos los datos para que tu aprobación sea más fácil</p>
				<p class="text-center "><a data-toggle="modal" href="#oportuyaBeneficiosModal"> Obtén más información
						sobre los beneficios y condiciones de tu tarjeta </a></p>
				<h3 class="forms-text-analyst text-center">Solo te tomará unos minutos solicitar tu tarjeta Oportuya
				</h3>
			</div>
			<div class="col-12">
			...
			<form role=form id="saveLeadOportuya" ng-submit="confirmnumCel()">
				<div class="row resetRow">
					<div class="col-12 col-sm-4 form-group">
						...
						<select class="form-control inputsSteps inputSelect" ng-model="leadInfo.typeDocument"
					...
					<div class="col-12 col-sm-4 form-group">
						...
						<input class="form-control inputsSteps inputText" type="text" validation-pattern="number"
							ng-model="leadInfo.identificationNumber" id="identificationNumber" required=""
							ng-blur="getNumCel()" />
					</div>
					<div class="col-sm-12 col-md-4 form-group">
						<label for="dateDocumentExpedition">Fecha Expedición Documento*</label>
						<div class="input-group" moment-picker="leadInfo.dateDocumentExpedition" format="YYYY-MM-DD">
							<input class="form-control inputsSteps inputText" ng-model="leadInfo.dateDocumentExpedition"
								id="dateDocumentExpedition" readonly="" required="" placeholder="Año/Mes/Día">
				...
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6 form-group">
						...
						<input type="text" ng-model="leadInfo.name" validation-pattern="name"
							class="form-control inputsSteps inputText" id="name" required="true" />
					</div>
					<div class="col-sm-12 col-md-6 form-group">
						<label for="lastName" class="control-label">Apellidos*</label>
						<input type="text" ng-model="leadInfo.lastName" validation-pattern="name"
							class="form-control inputsSteps inputText" id="lastName" required="true" />
					</div>
				</div>
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6 form-group">
						<label for="email" class="control-label">Correo electrónico*</label>
						<input type="text" ng-model="leadInfo.email" ng-blur="validateEmail()"
							validation-pattern="email" class="form-control inputsSteps inputText" id="email"
							required="true" />
					</div>
					<div class="col-sm-12 col-md-6 form-group">
						<label for="emailConfirm" class="control-label">Confirmar Correo electrónico*</label>
						<input type="text" ng-model="leadInfo.emailConfirm" ng-blur="validateEmail()"
							validation-pattern="email" class="form-control inputsSteps inputText" id="emailConfirm"
							required="true" />
					</div>
				...
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							...
							<input ng-hide="leadInfo.CEL_VAL" type="text" ng-model="leadInfo.telephone"
								validation-pattern="telephone" class="form-control inputsSteps inputText" id="telephone"
								required="true" ng-disabled="leadInfo.CEL_VAL" ng-blur="checkIfExistNum()" />
							<input ng-show="leadInfo.CEL_VAL" ng-model="telephone" ng-disabled="true" type="text"
					...
					<div class="col-sm-12 col-md-6">
						...
						<select id="occupation" class="form-control inputsSteps inputSelect"
							ng-model="leadInfo.occupation" required=""
							ng-options="occu.value as occu.label for occu in occupations">
						</select>
					</div>
				</div>
				<div class="row resetRow">
					<div class="col-12">
						<div class="form-group">
							...
							<select ng-model="leadInfo.city" id="city" class="form-control inputsSteps inputSelect"
								required="" ng-options="city.value as city.label for city in cities">
							</select>
						</div>
					</div>
				</div>
				...
				@endif
				<div class="form-group">
					<input type="checkbox" ng-model="leadInfo.termsAndConditions" id="termsAndConditions" value="1"
						required>
					<label for="termsAndConditions" style="font-size: 13px; font-style: italic;">
						Aceptar <a href="/Terminos-y-condiciones" class="linkTermAndCondition" target="_blank">términos
							y condiciones</a> y <a href="/Proteccion-de-datos-personales" class="linkTermAndCondition"
						...
						<div class="text-center" style="padding: 50px;">
							...
							<p class="text-procces">
								...
								<span style="font-size: 15px; font-style:italic; font-weight:normal">*No te desesperes,
									se están realizando las consultas necesarias, esto puede tomar un tiempo de
									aproximadamente 2 minutos</span>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="modal fade hide" data-backdrop="static" data-keyboard="false" id="confirmNumCel" tabindex="-1"
			role="dialog" aria-hidden="true">
					...
					<div class="modal-body" style="padding: 10px">
						<div class="row">
							<div class="col-12 form-group">
								...
								<input ng-hide="leadInfo.CEL_VAL" type="text" ng-model="leadInfo.telephone"
									validation-pattern="telephone" class="form-control inputsSteps inputText"
									id="telephone" required="true" ng-disabled="leadInfo.CEL_VAL" />
								<input ng-show="leadInfo.CEL_VAL" ng-model="telephone" ng-disabled="true" type="text"
									readonly class="form-control inputsSteps inputText">
								<div class="alert alert-warning" ng-show="leadInfo.CEL_VAL">
		...
		<div class="modal fade hide" data-backdrop="static" data-keyboard="false" id="confirmCodeVerification"
		...
		<div class="modal modalCardExist fade hide" data-backdrop="static" data-keyboard="false" id="cardExist"
			tabindex="-1" role="dialog" aria-hidden="true">
					...
					<div class="modal-body oportuyaModal-body">
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="row border-top min-height-modal-item">
									<div class="col-2 text-center">
										<img src="{{asset('images/icon-accede-oportuya.png')}}" alt=""
											class="img-fluid">
									</div>
									<div class="col-10">
								...
								<div class="row border-top border-bottom">
									<div class="col-2 text-center">
										<img src="{{asset('images/icon-rotativo-oportuya.png')}}" alt=""
											class="img-fluid">
									</div>
									<div class="col-10">
							...
							<div class="col-12 col-md-6">
								<div class="row border-top min-height-modal-item">
									<div class="col-2 text-center">
										<img src="{{asset('images/icon-descuentos-oportuya.png')}}" alt=""
											class="img-fluid">
									</div>
									<div class="col-10">
										Tienes acceso a los súper descuentos que lanzamos cada semana con los mejores
										precios por ser cliente Oportuya.
									</div>
								</div>
								<div class="row border-top border-bottom">
									<div class="col-2 text-center">
										<img src="{{asset('images/icon-seguros-oportuya.png')}}" alt=""
											class="img-fluid">
									</div>
									<div class="col-10">
						...
						<h5 class="text-center">
							Antes de iniciar con los pasos queremos que sepas que <br> tenemos muchas oportunidades de
							crédito para ti.
						</h5>
						<br>
							...
							<div class="col-12 pasos-oportuya">
								<div class="row">
									...
									<div class="col-md-3 col-12 text-center asesor-img-modal">
										<img src="{{asset('images/icon-asesor-oportuya.png')}}" alt=""
											class="img-fluid">
									</div>
								</div>
							</div>
