...
@section('content')
<div id="step3" ng-app="appStep3" ng-controller="step3Ctrl"
	...
	<div class="step3-containerForm">
		<div class="row resetRow">
			<div class="forms-descStep">
				...
				<span class="forms-descStepNum text-center">3</span>
			</div>
		</div>
		<form ng-submit="saveStep3()" id="formEmpleado">
			<div
				ng-if="leadInfo.occupation == 'EMPLEADO' || leadInfo.occupation == 'SOLDADO-MILITAR-POLICÍA' || leadInfo.occupation == 'PRESTACIÓN DE SERVICIOS'">
			...
			<div
				ng-if="leadInfo.occupation == 'INDEPENDIENTE CERTIFICADO' || leadInfo.occupation == 'NO CERTIFICADO' || leadInfo.occupation == 'RENTISTA'">
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6 form-group">
				...
				<div class="row resetRow">
					...
					<div class="col-sm-12 col-md-6 form-group"
						ng-if="leadInfo.occupation == 'NO CERTIFICADO' || leadInfo.occupation == 'RENTISTA'">
						...
						<div class="input-group" moment-picker="leadInfo.dateCreationCompany" format="YYYY-MM">
							<input class="form-control inputsSteps inputText" ng-model="leadInfo.dateCreationCompany"
								id="dateCreationCompany" readonly="" placeholder="Año/Mes" />
							<span class="input-group-addon">
								<i class="octicon octicon-calendar"></i>
							</span>
						</div>
					...
					<div class="col-sm-12 col-md-6 form-group"
						...
						<div class="input-group" moment-picker="leadInfo.dateCreationCompany" format="YYYY-MM">
							<input class="form-control inputsSteps inputText" ng-model="leadInfo.dateCreationCompany"
								id="dateCreationCompany" readonly="" placeholder="Año/Mes" required="" />
							<span class="input-group-addon">
								<i class="octicon octicon-calendar"></i>
							</span>
						</div>
			...
			<div ng-if="leadInfo.occupation == 'PENSIONADO'">
				...
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6 form-group">
						...
						<input type="number" id="antiquity" ng-model="leadInfo.antiquity" validation-pattern="number"
							class="form-control inputsSteps inputText" required="" />
					</div>
					<div class="col-sm-12 col-md-6 form-group">
						<label for="salaryInd">Salario</label>
				...
				<div class="row resetRow">
					<div class="col-sm-12 col-md-6 form-group">
						<label for="eps">EPS*</label>
						<input type="text" id="eps" required="" ng-model="leadInfo.eps" validation-pattern="textOnly"
							class="form-control inputsSteps inputText" />
					</div>
					<div class="col-sm-12 col-md-6 form-group">
			...
			<div class="row resetRow">
				...
				<div class="col-sm-12 col-md-6 form-group">
					...
					<input type="text" ng-model="leadInfo.NOM_REFPER" id="NOM_REFPER" validation-pattern="name"
						class="form-control inputsSteps inputText" required="true" />
				</div>
				<div class="col-sm-12 col-md-6 form-group">
					<label for="TEL_REFPER">Celular*</label>
					<input type="text" ng-model="leadInfo.TEL_REFPER" id="TEL_REFPER" validation-pattern="telephone"
						class="form-control inputsSteps inputText" required="true" />
				</div>
			</div>
			<div class="row resetRow">
				...
				<div class="col-sm-12 col-md-6 form-group">
					...
					<input type="text" ng-model="leadInfo.NOM_REFFAM" id="NOM_REFFAM" validation-pattern="name"
						class="form-control inputsSteps inputText" required="true" />
				</div>
				<div class="col-sm-12 col-md-6 form-group">
					<label for="TEL_REFFAM">Celular*</label>
					<input type="text" ng-model="leadInfo.TEL_REFFAM" id="TEL_REFFAM" validation-pattern="telephone"
						class="form-control inputsSteps inputText" required="true" />
				</div>
			</div>
			<div class="row resetRow">
	...
	<div class="modal modalSteps fade hide" data-backdrop="static" data-keyboard="false" id="congratulations"
					...
					<div class="row resetRow">
						<div class="col-12" ng-if="estadoCliente == 'APROBADO'">
							...
							<p class="textModalNumSolic text-center">
								Tu número de scolitud es <strong
									style="font-size:16px; color: #1b8acc">@{{ numSolic }}</strong> , <br> guárdala para
						...
						<div class="col-12 text-center containTextThankYouModal"
                            ...
                            <p class="textTnakYouModal">
                                <b>El aplicativo, está presentado un error, <br /> un asesor se pondra en contacto lo mas pronto posible.</b>
                            </p>
                        </div>
					</div>
					<div class="row resetRow containerFormModal">
						<div class="col-sm-7 offset-sm-5">
							<form ng-submit="sendComment()">
								...
								<div class="form-group">
									<textarea ng-model="comment.comment" class="form-control" rows="10"
