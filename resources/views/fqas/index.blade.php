          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form form method="POST" action="{{ route('fqas.update',$pregunta->id) }}">
                    {{ csrf_field() }}
        ...
        <div class="modal fade" id="Delete{{$pregunta->id}}" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <form form method="POST" action="{{ route('fqas.destroy',$pregunta->id) }}">
                    {{ csrf_field() }}
        ...
        <div class="modal fade" id="createModal" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form form method="POST" action="{{ route('fqas.store') }}">
                    {{ csrf_field() }}
                  <div class="form-group">
                    <label>Pregunta</label>
