    ...
    <form action="/Administrator/portfolioCollections" method="POST">
        ...
        <div class="container-payments shadow mt-4">
         <div class="p-4">
            ...
            <div class="form-group row">
                <label for="customer_id-input" class="col-3 col-form-label">Identificación</label>
                <div class="col-9">
                    <input required class="form-control" name="customer_id" type="text" id="customer_id-payments">
                </div>
            </div>
            <div class="form-group row">
                <label for="name-input" class="col-3 col-form-label">Nombre Cliente</label>
                <div class="col-9">
                    <input required class="form-control" name="customer" type="text" id="customer-payments">
                </div>
            </div>
            <div class="form-group row">
                <label for="reference-input" class="col-3 col-form-label">No. Credito</label>
                <div class="col-9">
                    <input required class="form-control" name="payment_reference" type="text" id="payment_reference">
                </div>
            </div>
            <div class="form-group row">
                <label for="amount-input" class="col-3 col-form-label">Valor a Pagar</label>
                <div class="col-9">
                    <input required class="form-control" name="amount" type="number" id="amount-payments">
                </div>
            </div>
            <div class="form-group row">
                <label for="date-input" class="col-3 col-form-label">Fecha Recibo</label>
                <div class="col-9">
                    <input required class="form-control" name="payment_date" value="{{ date('d/m/Y') }}" type="datetime"
                        id="payment-date" readonly>
                </div>
            </div>
