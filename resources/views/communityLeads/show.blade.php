        ...
        <div class="tab-content mt-4" id="tabcontent">
            <div role="tabpanel" class="tab-pane container-fluid active" id="info">
                <div class="container-fluid card">
                    ...
                    @include('communityLeads.layouts.generals')
                </div>

                <div class="container-fluid mt-5 card">
                    @include('communityLeads.layouts.customer')

                </div>

                <div class="container-fluid mt-5 card">
                    @include('communityLeads.layouts.creditcard')
            ...
            <div class="row border-0">
                <a href="{{ route('communityLeads.index') }}" class="btn btn-default btn-sm">Regresar</a>
            </div>
