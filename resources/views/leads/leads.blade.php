                    ...
                    <table id="example2"
                        ...
                        <tbody>
                            <tr ng-repeat="lead in leadsTR">
                                ...
                                <td>
                                    <i class="fas fa-comment cursor"
                                        ng-click="viewCommentsCustomer(lead.NOMBRES, lead.APELLIDOS, lead.CEDULA)"></i>
                                    {{-- <i class="fas fa-check cursor"
                                        ng-click="assignAssesorDigitalToLead(lead.CEDULA)"></i> --}}
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<div class="modal fade" id="viewCustomerComments" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Ver Comentarios - @{{ nameLead }} @{{ lastNameLead }}
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row resetRow " ng-if="viewAddComent">
                        <div class="col-12 form-group">
                            <form ng-submit="addCustomerComment()">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="comment">Comentario</label>
                                    <textarea ng-model="comment.comment" id="comment" cols="10" class="form-control"
                ...
                <tr ng-repeat="leadCM in leadsCM">
                    <td>
                        ...
                        <span class="text-center badge" ng-if="leadCM.state == 6"
                            style="color: #ffffff; background-color: red" class="btn btn-info btn-block">Negado</span>
...
<div class="form-group row">
    <div class="col-12 col-sm-6">
        ...
        <input type="text" ng-model="lead.name" validation-pattern="name" id="name" cols="10" class="form-control"
...
<div class="form-group row">
    <div class="col-12 col-sm-6">
        ...
        <input type="text" ng-model="lead.email" validation-pattern="email" id="email" cols="10" class="form-control"
            value="@{{lead.email}}">
    </div>
    <div class="col-12 col-sm-6 no-padding-right">
...
<div class="form-group row">
    ...
    <select id="socialNetwork" class="form-control" ng-model="lead.campaign"
        ...
        <option ng-repeat="campaign in campaigns" value="@{{ campaigns.value}}" label="@{{ campaigns.label}}">
            @{{campaigns.value}}
        </option>
    </select>
</div>
...
<div class="row">
    <div class="col-6 d-flex align-items-end">
        <div class="form-group w-100">
            ...
            <select class="form-control  select2" id="state" name="state" ng-model="lead.state" style="width: 100%;">
                        ...
                        <form ng-submit="addCommunityLeads()" id="addCommunityForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 form-group no-padding-right">
                                    <label for="lastName">Apellido <span class="text-danger">*</span></label>
                                    <input type="text" ng-model="lead.lastName" validation-pattern="name" id="lastName"
                                        cols="10" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
