...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade card mb-4 border-0" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab "
        ng-class="{ 'show active': tabs == 7 }" style="box-shadow: 0 3rem 4rem rgba(0,0,0,.175) !important;">
            ...
            <div class="card-body">
                <div class="table reset-table ">
                    ...
                    <div class="row">
                        ...
                        <div class="modal fade" id="viewComments" tabindex="-1" role="dialog"
                            ...
                            <form ng-submit="addCommunityLeads()" id="addCommunityForm">
                                ...
                                <div class="row">
                                    <div class="col-12 form-group">
                                        ...
                                        <input type="text" class="form-control" validation-pattern="IdentificationNumber" required id="identificationNumber"                                          ng-model="lead.identificationNumber">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-sm-6 form-group">
