<div class="card-header">
  <h2><i class="fas fa-tags" aria-hidden="true"></i> Solicitud {{ $lead }} Sucursal
    {{ $lead }} {{ $lead }}
  </h2>
</div>
<div class="card-body table-responsive pt-1">
  <table class="table table-hover table-stripped leadTable">
    ...
    <tbody>
      <tr>
        <td class="text-center">{{ $lead->FECHASOL }}</td>
        <td class="text-center">{{ $lead->CODEUDOR1 }}/{{ $lead->CODEUDOR2 }}/{{ $lead->CODEUDOR3 }}</td>
        <td class="text-center">{{ $lead->CODASESOR }}</td>
        <td class="text-center">{{ $lead->GRAN_TOTAL }}</td>
        <td class="text-center">{{ $lead->PRODUC_W }}</td>
        <td class="text-center">{{ $lead->AVANCE_W }}</td>
      </tr>
    </tbody>
  </table>
</div>
