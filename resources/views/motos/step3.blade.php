...
@section('content')
	<div id="step3" ng-app="appMotoStep3" ng-controller="motoStep3Ctrl" ng-init="leadInfo.identificationNumber = {{$identificationNumber}}" ng-cloak>
		<div class="row resetRow container-header-forms">
			<div class="form-container-logoHeader form-container-logoHeader-avances">
				<img src="{{ asset('images/logoMotosCredito.png') }}" class="img-fluid" alt="Oportuya" />
			</div>
		...
		<div class="step3-containerForm">
			...
			<form ng-submit="saveStep3()" id="formEmpleado" >
				<div ng-if="leadInfo.occupation == 'EMPLEADO' || leadInfo.occupation == '1' || leadInfo.occupation == 'SOLDADO-MILITAR-POLICÍA' || leadInfo.occupation == '6'">
					<div class="row resetRow">
				...
				<div ng-if="leadInfo.occupation == 'INDEPENDIENTE CERTIFICADO' || leadInfo.occupation == '2' || leadInfo.occupation == 'NO CERTIFICADO' || leadInfo.occupation == '3' || leadInfo.occupation == 'RENTISTA' || leadInfo.occupation == '5'">
					<div class="row resetRow">
						<div class="col-sm-12 col-md-6 form-group">
				...
				<div ng-if="leadInfo.occupation == 'PENSIONADO' || leadInfo.occupation == '4'">
					<div class="row resetRow">
						<div class="col-sm-12 col-md-6 form-group">
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/motoStep3.js') }}"></script>
