...
<div id="construccion">
	<div class="container">
		...
		<p class="text-center">Si te interesa conocer más sobre nuestros créditos para motos, déjanos tus datos y un
			asesor se pondrá en contacto</p>
			...
			<div class="modal-containerFormulario">
				...
				<form role=form method="POST" id="saveLeadmotos" action="{{ route('motos.store') }}">
					...
					<div class="form-group">
						...
						<input type="text" name="name" id="name" class="form-control" validation-pattern="name"
							required="true" />
					</div>
					<div class="form-group">
						<label for="lastName" class="control-label">Apellidos</label>
						<input type="text" name="lastName" id="lastName" class="form-control" validation-pattern="name"
							required="true" />
					</div>
					<div class="form-group">
						<label for="email" class="control-label">Correo electrónico</label>
						<input type="email" name="email" id="mail" class="form-control" validation-pattern="email"
							required="true" />
					</div>
					<div class="form-group">
