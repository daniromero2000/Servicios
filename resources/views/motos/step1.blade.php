...
@section('content')
	 {!! NoCaptcha::renderJs() !!}
	<div id="step1" ng-app="appMotoStep1" ng-controller="motoStep1Ctrl">
		<div class="row resetRow container-header-forms">
			<div class="form-container-logoHeader">
				<img src="{{ asset('images/logoMotosCredito.png') }}" class="img-fluid" alt="Motos" />
			</div>
		...
		<div class="row resetRow">
			<div class="col-12 step2-containTitle">
				<h2 class="text-center step2-titleAnalista"><strong>Hola!</strong> @{{digitalAnalyst.name}}</h2>
				<p class="text-center step2-textAnalista">En este momento te encuentras haciendo tu solicitud de crédito para motos, por favor diligencia <br> todos los datos para que tu aprobación sea más fácil</p>
				<h3 class="forms-text-analyst text-center">Solo te tomará unos minutos solicitar tu crédito</h3>
			</div>
			<div class="col-12">
...
@section('scriptsJs')
	...
	<script type="text/javascript" src="{{ asset('js/motoStep1.js') }}"></script>
	<script>
