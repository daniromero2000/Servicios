...
@section('content')
	<div id="step2" ng-app="appMotoStep2" ng-controller="motoStep2Ctrl" ng-init="leadInfo.identificationNumber = {{$identificationNumber}}" ng-cloak>
		<div class="row resetRow container-header-forms">
			...
			<div class="col-12 conatiner-logoImg">
				...
				<span class="steps-textStep"><strong>Solicitud de crédito para moto Paso 2</strong> > (Información Personal)</span>
			</div>
		</div>
...
@section('scriptsJs')
	<script type="text/javascript" src="{{ asset('js/motoStep2.js') }}"></script>
