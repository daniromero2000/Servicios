    ...
    <table class="table table-head-fixed table-hover table-stripped leadTable">
      ...
      <tbody class="body-table">
        ...
        <tr>
          ...
          <td class="text-center"> @if (empty($cifin_fin_extint->extvrmora)) 0 @endif
            {{ number_format (($cifin_fin_extint->extvrmora*1000)) }}
          </td>
          <td class="text-center"> @if (empty($cifin_fin_extint->extvrcuot)) 0 @endif
            {{ number_format (($cifin_fin_extint->extvrcuot*1000)) }}
          </td>
