                    ...
                    <div class="col-12 col-sm-12 col-md-12">
                        <div class="small-box bg-primary">
                            ...
                            <div class="col-12 text-right color-white">
                                <span class="info-box-text text-right"><a href="{{ route('customers.index') }}" style="color: white; !important">Ver
                                        Más</a></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="info-box ">
                            ...
                            <div class="info-box-content">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <span class="info-box-text text-right"><a href="{{ route('customers.index') }}" style="color: black; !important">Ver
                                                Más</a></span>
                                    </div>
                                </div>
                                <div class="progress">
                        ...
                        <div class="row text-center">
                            <div class="col-12 d-flex justify-content-center">
                                ...
                                <div class="col-6 header-table mt-2">
                                    <p><span @if ($customersRuaf['fuenteFallo']=='SI' ) class="badge badge-danger" @else class="badge badge-primary" @endif>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-6 header-table mt-2">
                                    ...
                                    <p> <span @if ($customersFosyga['fuenteFallo']=='SI' ) class="badge badge-danger" @else class="badge badge-primary" @endif> {{ number_format ($customersFosyga['percentage']) }} % </span>
                    ...
                    <div class="card">
                        ...
                        <div class="row text-center">
                            <div class="col-12 d-flex justify-content-center">
                                ...
                                <div class="col-6 header-table mt-2">
                                    <p><span @if ($customerRegistraduria['fuenteFallo']=='SI' ) class="badge badge-danger" @else class="badge badge-primary" @endif>
