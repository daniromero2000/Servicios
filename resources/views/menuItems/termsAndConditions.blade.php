...
<script>
    window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);} gtag('js',new Date());gtag('config','AW-781153823',{'page_title':'Términos y condiciones generales.','page_path':'/Terminos-y-condiciones'});
</script>
...
@section('content')
	<div id="termsAndConditions">
		...
		<div class="container">
			...
			<p class="menuItem-text">
				Si el usuario hiciera uso de la página de LAGOBO, ello implicará la aceptación plena de las condiciones establecidas en los términos y condiciones generales. Por dicha utilización de este sitio y/o sus servicios, el usuario se obligará a cumplir expresamente con las mismas, razón por la cual no podrán no alegar el desconocimiento de tales términos y condiciones generales.
			</p>
			<h2 class="menuItem-subtitle">PROPIEDAD DE ESTE SITIO:</h2>
			<p class="menuItem-text">
				Estos términos y condiciones generales de uso aplican a este sitio web disponible en https://www.serviciosoportunidades.com/, el cual es propiedad de LAGOBO, sociedad legalmente constituida en Colombia con NIT 800.135.342-6. Los derechos de propiedad intelectual o industrial de la página son propiedad de LAGOBO, queda estrictamente prohibida la divulgación, reproducción, distribución o comunicación pública total o parcial de cualquier parte de esta herramienta sin la previa autorización por escrito por parte de LAGOBO. El contenido que se presenta en la página, entiéndase como el material informativo, fotográfico, multimedia y publicitario, es de propiedad exclusiva de LAGOBO, el uso de la información contenida en ésta solo le corresponde a LAGOBO o a terceros expresamente autorizados para ello. Las personas que no estén autorizadas deberán abstenerse de extraer o reutilizar dicha información. LAGOBO, tiene el derecho de rechazar el ingreso del “usuario” a la página. El “usuario” entiende que en esta herramienta no se lleva a cabo ningún tipo de aprobación de crédito.
			</p>
			<h2 class="menuItem-subtitle">CONTENIDO:</h2>
			<p class="menuItem-text">
				Todos los textos, gráficos, diseños, interfaces de usuario, fotografías, logos, música, emblemas comerciales y código fuente (en adelante “el contenido) del https://www.serviciosoportunidades.com/ son propiedad LAGOBO o se encuentran licenciados. El Contenido del Sitio Web se encuentra protegido por derechos de autor.
			</p>
			<p class="menuItem-text">
				El Contenido de este Sitio Web no puede ser copiado, reproducido, posteado, transmitido, republicado, trasladado o distribuido de ninguna manera a otro computador, servidor, o cualquier otro medio sin autorización por escrito de LAGOBO.
			</p>
			<p class="menuItem-text">
				Las etiquetas, opiniones y calificaciones expresadas por los usuarios sobre los productos en https://www.serviciosoportunidades.com/ no representan una asesoría ni la opinión de LAGOBO.
			</p>
			<p class="menuItem-text">
				Lagobo Distribuciones S.A.S no revisa cada una de las etiquetas, calificaciones ni opiniones expresadas por los usuarios. Sin embargo se reserva el derecho de aceptarlas o eliminarlas parcial o totalmente, en cualquier momento, a su discreción, sin previo aviso y sin dar explicaciones al usuario que las emite.
			</p>
			<p class="menuItem-text">
				LAGOBO se reserva el derecho de corregir en cualquier momento y en forma unilateral cualquier error u omisión en cualquier Contenido publicado en el https://www.serviciosoportunidades.com/.
			</p>
			<p class="menuItem-text">
				No nos hacemos cargo de los daños o perjuicios derivados del mal uso de la información de la página, pues el usuario entiende y acepta que el acceso a esta herramienta, así como el uso que pueda hacerse de los servicios e información contenida en la misma, son de la exclusiva responsabilidad del “usuario” que los realiza.
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Advierte que algunos de los textos contenidos en la página, enlaces y/o información incluidos en la misma podrían no ser veraces o no estar actualizados o haber sido recibidos o informados por terceras personas sobre las cuales LAGOBO no tiene control. Por dicha razón, LAGOBO, no responderá sobre los errores u omisiones relativos a la información que no sea de su autoría, ni tampoco de los daños o perjuicios que se puedan llegar a ocasionar como resultado del uso de dicha información. Además cabe resaltar que aunque este es un sitio seguro, no está libre de errores y en consecuencia la información general, así como las características de los productos anunciados y los precios, pueden variar con ocasión de errores humanos, tecnológicos, manipulación por terceros no autorizados, virus o cualquier evento de invasión o manipulación tecnológica.
			</p>
			<h2 class="menuItem-subtitle">USOS NO PERMITIDOS DEL SITIO WEB:</h2>
			<p class="menuItem-text">
				Las siguientes actividades no se encuentran permitidas sobre el Sitio Web https://www.serviciosoportunidades.com/:
			</p>
			<p class="menuItem-text">
				Anidar páginas del Sitio Web dentro de “frames” de Sitios externos.
			</p>
			<p class="menuItem-text">
				Utilizar “spiders”, “site copiers” o cualquier otro dispositivo, programa, algoritmo o método para acceder, adquirir, copiar o monitorear cualquier parte o contenido de https://www.serviciosoportunidades.com/.
			</p>
			<p class="menuItem-text">
				Intentar obtener acceso privilegiado a cualquier parte del Sitio Web, servidores o redes mediante “haking”, “password mining" o cualquier método.
			</p>
			<p class="menuItem-text">
				Revisar o escanear el Sitio Web, servidores o redes de https://www.serviciosoportunidades.com/, en busca vulnerabilidades de seguridad.
			</p>
			<p class="menuItem-text">
				Hacer “look-up”, “trace” o “sniffer” a la información transmitida desde o hacia cualquier usuario del Sitio Web.
			</p>
			<p class="menuItem-text">
				Hacer intentos desproporcionados de utilización del Sitio Web, los servidores o las redes de Lagobo Distribuciones S.A.S que puedan derivar en la negación del Servicio.
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				En los contratos ofrecidos por medio de esta página web, se informará de manera inequívoca y fácilmente accesible, los pasos que deberán seguirse para celebrarlos, e informará, cuando corresponda, si el documento electrónico en que se formalice el contrato será archivado y si éste será accesible al usuario. El sólo hecho de seguir los pasos que para tales efectos se indiquen en este sitio para efectuar una compra, equivale a aceptar que efectivamente se ha dado cumplimiento a las condiciones contenidas en este apartado. A su vez, se indicará la dirección de correo postal o electrónico y los medios tecnológicos a disposición del usuario para identificar y corregir los errores en el envío o en sus datos.
			</p>
			<h2 class="menuItem-subtitle">REGISTRO Y USO DEL SITIO:</h2>
			<p class="menuItem-text">
				El registro del sitio se hará de diferentes maneras, como el usuario lo defina, si es por el boletín de suscriptores, el bono de regalo o a través de la creación de una cuenta.
			</p>
			<h2 class="menuItem-subtitle">CAPACIDAD LEGAL:</h2>
			<p class="menuItem-text">
				Los servicios sólo están disponibles para personal que tengan capacidad legal para contratar. No podrán utilizar los servicios las personas que no tengan esa capacidad y los menores de edad. Los actos que éstos realicen en este sitio serán responsabilidad de sus padres, tutores, encargados o curadores, y por tanto se consideran realizados por éstos en ejercicio de la representación legal con la que cuenten. Quien registre un usuario como empresa , deberá tener capacidad para contratar a nombre de tal entidad y de obligar a la misma en los términos de este acuerdo.
			</p>
			<h2 class="menuItem-subtitle">MEDIOS DE PAGO QUE SE PODRÁN UTILIZAR EN EL SITIO:</h2>
			<p class="menuItem-text">
				Los productos y servicios ofrecidos en esta página web, salvo que se señale una forma diferente para casos particulares u ofertas de determinados bienes o servicios, sólo pueden ser pagadas con los medios que en cada caso específicamente se indiquen. El uso de tarjetas de crédito se sujetará a lo establecido en los estos términos y condiciones y, en relación su emisor y a lo pactado en los respectivos contratos.
			</p>
			<p class="menuItem-text">
				En caso de contradicción, predominará lo expresado en ese último instrumento. Tratándose de tarjetas bancarias aceptadas en el Sitio, los aspectos relativos a éstas, tales como la fecha de emisión, caducidad, cupo, bloqueos, etc., se regirán por el respectivo contrato, de tal forma que las Empresas no tendrán responsabilidad por cualquiera de los aspectos señalados.
			</p>
			<p class="menuItem-text">
				Esta página web podrá indicar determinadas condiciones de compra según el medio de pago que se utilice por el usuario. LAGOBO podrá otorgar descuento en la forma de créditos que los usuarios podrán descontar en su compra. En cada caso LAGOBO determinará unilateralmente el monto máximo de créditos que el usuario podrá utilizar en una compra y lo detallará en el sistema, previo a iniciar el proceso de pago. Los créditos utilizados por los usuarios no serán reintegrados en caso de devolución de los productos, por cualquier causa que esto ocurriera.
			</p>
			...
			<p class="menuItem-text">
				Los precios de los productos y servicios disponibles en este sitio, mientras aparezcan en él, sólo tendrán vigencia y aplicación en éste y no serán aplicables a otros canales de venta utilizados, tales como tiendas físicas, venta telefónica, otros sitios de venta por vía electrónica, catálogos u otros. Los precios de los productos ofrecidos en el sitio están expresados en pesos colombianos salvo que se manifieste lo contrario. Los precios ofrecidos corresponden exclusivamente al valor del bien ofrecido y no incluyen gastos de transporte, manejo, envío, accesorios que no se describan expresamente ni ningún otro ítem adicional.
			</p>
			<p class="menuItem-text">
				Adicionalmente, es posible que cierto número de productos puedan tener un precio incorrecto. De existir un error tipográfico en alguno de los precios de los productos, si el precio correcto del artículo es más alto que el que figura en la página, a nuestra discreción, LAGOBO lo contactará antes de que el producto sea enviado, y/o cancelaremos el pedido y le notificaremos acerca de la cancelación.
			</p>
			<h2 class="menuItem-subtitle">PROMOCIONES:</h2>
			<p class="menuItem-text">
				Las promociones que se ofrezcan en este sitio web no son necesariamente las mismas que ofrezcan otros canales de venta utilizados por LAGOBO, tales como tiendas físicas, venta telefónica, catálogos u otros, a menos que se señale expresamente en este sitio o en la publicidad que se para cada promoción. Cuando el Sitio ofrezca promociones que consistan en la entrega gratuita o rebajada de un producto por la compra de otro, el despacho del bien que se entregue gratuitamente o a precio rebajado, se hará en el mismo lugar en el cual se despacha el producto comprado. LAGOBO somete sus promociones y actividades promocionales al cumplimiento de las normas vigentes y específicamente a las disposiciones de la ley 1480 de 2011.
			</p>
			<p class="menuItem-text">
				En virtud a lo reglado en el artículo 49 literal b) de la Ley 1480 de 2011 y capítulo 37 del Decreto 1074 de 2015, dando protección a los derechos del consumidor y especialmente en lo referente a suministrar información cierta, fidedigna y suficiente, precisamos que los precios y ofertas de esta página web aplican exclusivamente para compras online. De manera que en ningún caso tendrán validez o podrán hacerse efectivos por otros medios o canales comerciales.
			</p>
			<h2 class="menuItem-subtitle">DESPACHO DE LOS PRODUCTOS:</h2>
			<p class="menuItem-text">
				Los productos adquiridos a través de este sitio web se sujetarán a las condiciones de despacho y entrega elegidas por el usuario y disponibles en la página web. La información del lugar de envío es de exclusiva responsabilidad del usuario. Los plazos elegidos para el despacho y entrega, se cuentan desde que LAGOBO haya validado la orden de compra y el medio de pago utilizado, y se consideran días hábiles para el cumplimiento de dicho plazo. Los pedidos serán despachados de los depósitos de LAGOBO CINCO (_5_) días hábiles después de finalizada la venta.
			</p>
			<p class="menuItem-text">
				LAGOBO comunicará por mail a los usuarios los datos para que pueda realizar el seguimiento del estado del envío por internet.
			</p>
			<p class="menuItem-text">
				Si el usuario se encontrara ausente cuando se le visita para dejar el pedido y nadie lo recibe en el lugar de residencia, se dejará un aviso en el que figure la hora de la visita. Durante los siguientes tres (3) días del primer intento, el correo regresará al domicilio para efectuar la entrega del pedido. En caso que nuevamente nadie reciba el producto, se realizará un tercer intento que de ser fallido, el producto será reintegrado a LAGOBO, debiendo el usuario ponerse en contacto con nuestras oficinas para coordinar una nueva entrega cuyo costo estará a exclusivo cargo del usuario.
			</p>
			<p class="menuItem-text">
				Advertencia: LAGOBO no puede garantizar el envío a algunas regiones del país de productos considerados sobre-dimensionados o con peso excesivo por las empresas de correo. Cuando esto suceda nos reservamos el derecho de revocar los pedidos que se encuentren en estas condiciones, caso en el cual la orden será reversada y el valor del precio será reembolsado al cliente en el menor tiempo posible.
			</p>
			<h2 class="menuItem-subtitle">POLÍTICA DE DEVOLUCIÓN Y CAMBIOS POR DERECHO DE RETRACTO:</h2>
			<p class="menuItem-text">
				LAGOBO, para comercializar productos, ofrece a sus clientes la posibilidad de retractarse de la compra durante los primeros cinco (_5_) días hábiles siguientes a la entrega del producto, de conformidad con el artículo 47 de la Ley 1480 de 2011.
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Después de realizar el retracto, LABOGO tendrá máximo 48 horas hábiles para enviar la guía de logística inversa para la devolución de producto, si este no se envía dentro de los primeros 5 días hábiles después de enviada la guía se entenderá que el cliente desea cancelar el retracto. Los costos de transporte y demás, incurridos en la devolución serán asumidos por el cliente.
			</p>
			...
			<p class="menuItem-text">
				En caso que su crédito sea desistido o negado, el formato denominado autorización de consulta en centrales de riesgo, será separado de los demás documentos suscritos por el consumidor y tratado como se indica en la política de "envió de documentos de crédito al archivo". Este documento podrá ser conservado en cualquier medio técnico, magnético o electrónico que garantice su reproducción exacta, de conformidad con lo reglado en el artículo 28 de la Ley 962 de 2005. Los demás formatos y títulos valores suscritos serán anulados de manera inmediata en la sucursal y posteriormente destruidos.
			</p>
			...
			<p class="menuItem-text">
				LAGOBO cuenta con una “Política de tratamiento de información y protección de datos personales” las cuales hacen parte integral de estos términos y condiciones de uso, los cuales podrá consultar en el siguiente enlace <a href="/Proteccion-de-datos-personales" target="_BLANK">Aquí</a>
			</p>
