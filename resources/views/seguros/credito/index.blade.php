...
<script>
	window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);} gtag('js',new Date());gtag('config','AW-781153823',{'page_title':'Crédito Seguros','page_path':'/seguros/credito'});
</script>
				...
				<div class="col-12 col-sm-12 col-md-12 type-client">
					...
					<div class="row">
						...
						<div class="col-12 col-md-4">
							...
							<input class="inputs form-control" validation-pattern="IdentificationNumber" ng-blur="getValidationLead()" type="text" ng-model="lead.CEDULA" id="CEDULA" required />
						</div>
						<div class="col-12 col-md-4">
					...
					<div class="row">
						<div class="col-12 col-md-4">
							...
							<input class="inputs form-control" id="nombres" validation-pattern="name" ng-model="lead.NOMBRES" type="text" required />
						</div>
						<div class="col-12 col-md-4">
							<label class="labels" for="lastName">Apellidos*</label>
							<input class="inputs form-control" id="lastName" validation-pattern="name" type="text" ng-model="lead.APELLIDOS" required />
						</div>
						<div class="col-12 col-md-4">
							<label class="labels" for="email">Correo electrónico*</label>
							<input class="inputs form-control" id="email" type="text" validation-pattern="email" ng-model="lead.EMAIL" required />
						</div>
					</div>
					<div class="row">
						<div class="col-12 col-md-4">
				...
				<div class="col-12 col-sm-12 col-md-12 type-client">
					...
					<div class="row">
						<div class="col-12 col-md-4">
							...
							<input class="inputs form-control" id="antiquity" validation-pattern="number" type="number" ng-model="lead.TIEMPO_VIV" required />
						</div>
						<div class="col-12 col-md-4"  ng-show="lead.TIPOV == 'ARRIENDO' || lead.TIPOV == 'FAMILIAR'">
							...
							<input class="inputs form-control" id="PROPIETARIO" validation-pattern="name" type="text" ng-model="lead.PROPIETARIO" />
						</div>
						<div class="col-12 col-md-4" ng-show="lead.TIPOV == 'ARRIENDO'">
							<label class="labels" for="VRARRIENDO">Valor del arriendo</label>
							<input class="inputs form-control" ng-currency="" fraction="0" min="0" id="VRARRIENDO" type="text" ng-model="lead.VRARRIENDO" />
						</div>
					</div>
					<div class="row">
							...
							<div class="col-12">
								...
								<div class="row">
									...
									<div class="text-center">
										<a class="btn btn-danger buttonBackCardExist" href="/seguros/credito">Regresar</a>
									</div>
									</div>
								</div>
							</div>
