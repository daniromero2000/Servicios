<div class="card card-primary card-outline card-outline-tabs">
    <div class="card-header p-0 border-bottom-0">
        <nav>
            <div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
                <a class="nav-item nav-link cursor" id="nav-general-tab@{{key}}" ng-repeat="(key, tab) in liquidator" ng-click="alterTab(key)" ng-class="{ 'active': tabItem == key }" data-toggle="tab" role="tab" aria-controls="nav-general@{{key}}">Item <td class="d-flex">
    ...
    <div class="card-body" ng-if="key != 0">
        <div class="tab-content" id="nav-tabContent@{{key}}" ng-repeat="(key, tab) in liquidator">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group ">
                                    <label>Aplica IVA?
                                        <input type="checkbox" ng-model="liquidator[key][3].check" ng-click="refreshLiquidator(key)">
                                    </label>
                                </div>
                                <div class="form-group ">
                                    <label for="name">Plan <span class="text-danger">*</span></label>
                                    <select ng-model="liquidator[key][3].COD_PLAN" id="plan" ng-blur="createPlan(key)" name="plan" class="form-control " required>
                                ...
                                <div class="form-group ">
                                    <label>Desea incrementar la cuota inicial?
                                        <input type="checkbox" ng-model="liquidator[key][3].checkInitialFee" ng-click="refreshLiquidator(key)">
                                    </label>
                                </div>
                                <div class="form-group ">
                                    <label for="initialFee">Cuota inicial</label>
                                    <input required type="text" class="form-control" id="initialFee" ng-model="liquidator[key][3].CUOTAINI" ng-currency aria-describedby="initialFee" ng-blur="refreshLiquidator(key)">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select ng-model="liquidator[key][3].PLAZO" id="feeInitial" ng-blur="addFee(key)" name="feeInitial" class="form-control " required>
                                        ...
                                        <div class="row mx-0">
                                            <div class="col-12">
                                                <ul class="ml-4 mb-0 fa-ul text-muted mx-auto" style=" max-width: 280px; padding: 0px 20px;">
                                                    ...
                                                    <li class="mt-2 small d-flex justify-content-between"><span class="fa-li"><i class="fas fa-shield-alt"></i></span>
                                                        Seguro:
            ...
            <input class="form-control" type="hidden" id="typeLiquidator" value="{{auth()->user()->Assessor->ID_EMPRESA}}">
            @if(auth()->user()->Assessor->ID_EMPRESA == '3')
