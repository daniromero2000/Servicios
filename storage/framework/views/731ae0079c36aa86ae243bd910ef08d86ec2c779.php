...
<style>
    ...
    .textareaReadOnly{
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text"><?php echo $pregunta->answer; ?> </p>
          </div>
        </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form form method="POST" action="<?php echo e(route('faqs.update',$pregunta->id)); ?>">
        ...
        <div class="modal fade" id="Delete<?php echo e($pregunta->id); ?>" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <form form method="POST" action="<?php echo e(route('faqs.destroy',$pregunta->id)); ?>">
                    <?php echo e(csrf_field()); ?>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form form method="POST" action="<?php echo e(route('faqs.store')); ?>">
                    <?php echo e(csrf_field()); ?>
