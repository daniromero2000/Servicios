...
<div Class="contentGarantias">
    <div class="align-self-center ml-auto ">
        <a href="<?php echo e(route('TermsAndConditions')); ?>" class="align-middle warrantyLegal-xs">Términos y condiciones</a>
    </div>
    <div class="row resetRow">
        <div class="logoHeaderWarranty">
            <img src="<?php echo e(asset('images/warranty-oportunidades.png')); ?>" class="img-fluid" alt="Oportuya" />
        </div>
        <div class="align-self-center ml-auto conditions">
            <a href="<?php echo e(route('TermsAndConditions')); ?>" class="align-middle warrantyLegal">Términos y condiciones</a>
        </div>
        <div class="col-12 conatiner-imgAnalista">
            <img src="<?php echo e(asset('images/analistaGarantiaDigital.png')); ?>"  alt="" class="img-fluid imgAnalista" />
        </div>
    ...
    <div class="Garantia-containerForm">
        <div class="row resetRow">
            <div class="descriptionStep">
                ...
                <img src="<?php echo e(asset('images/datosPersonales-min.png')); ?>" class="img-fluid forms-descImg" />
        ...
        <form ng-submit="sendRequest()">
            ...
            <div class="row resetRow">
                <div class="descriptionStep">
                    ...
                    <img src="<?php echo e(asset('images/datosPersonales2-min.png')); ?>" class="img-fluid forms-descImg" />
            ...
            <div class="row resetRow">
                <div class="descriptionStep">
                    ...
                    <img src="<?php echo e(asset('images/datosLaborales-min.png')); ?>" class="img-fluid forms-descImg" />
