...
<div class="wrapper">
   <nav class="navBarButton navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div id="dashboardContent" class="tab-content">        
      ...
      <div id="modulesDashboard" role="tabpanel" class="container dashboardContainer tab-pane tab-content">
        <?php echo $__env->make('dashboard.modules', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>

      <div id="homeDashboard" role="tabpanel" class="current tab-pane tab-content"> 
          <?php echo $__env->make('dashboard.home', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>

      <div id="mainDashboard" role="tabpanel" class="tab-pane tab-content"> 
          <?php echo $__env->make('dashboard.mainDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>

      <div id="contactsDashboard" role="tabpanel" class="tab-pane tab-content"> 
          <?php echo $__env->make('dashboard.contact', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>

      <div id="calendarDashboard" role="tabpanel" class="tab-pane tab-content"> 
          <?php echo $__env->make('dashboard.calendar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>
  </div>
