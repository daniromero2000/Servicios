           ...
           <div class="col-md-12 col-lg-4 container-creditoLibranzaCards">
            ...
            <div class="col-md-12 col-lg-4 container-creditoLibranzaCards">
                <div class="creditoLibranza-contianerTexto creditoLibranza-libreInversion">
                    <img src="<?php echo e(asset('images/libranza-libreInversion.png')); ?>" alt="Crédito Libre Inversión" class="img-fluid creditoLibranza-img">
            ...
            <div class="col-md-12 col-lg-4 container-creditoLibranzaCards">
                <div class="creditoLibranza-contianerTexto creditoLibranza-motos">
                    <img src="<?php echo e(asset('images/libranza-compraCartera.png')); ?>" alt="Compra de cartera" class="img-fluid creditoLibranza-img">
                    <div class="containerText-creditoLibranzaCards">
...
<script src="<?php echo e(asset('js/appLibranzaPublic/controllers/libranza.js')); ?>"></script>
<script> src="<?php echo e(asset('js/bower_components/angular-slick-carousel/dist/slick.js')); ?>"</script>
<?php $__env->stopSection(); ?>
