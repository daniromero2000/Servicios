<?php $__env->startSection('title', 'Oportunidades Sevicios - Términos y condiciones generales.'); ?>
...
<?php $__env->startSection('content'); ?>
	<div id="termsAndConditions">
		...
		<div class="container">
			...
			<p class="menuItem-text">
				Todos los textos, gráficos, diseños, interfaces de usuario, fotografías, logos, música, emblemas comerciales y código fuente (en adelante “el contenido) del www.serviciosoportunidades.com son propiedad LAGOBO o se encuentran licenciados. El Contenido del Sitio Web se encuentra protegido por derechos de autor.
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Las etiquetas, opiniones y calificaciones expresadas por los usuarios sobre los productos en www.serviciosoportunidades.com no representan una asesoría ni la opinión de LAGOBO.
			</p>
			<p class="menuItem-text">
				Lagobo Distribuciones S.A no revisa cada una de las etiquetas, calificaciones ni opiniones expresadas por los usuarios. Sin embargo se reserva el derecho de aceptarlas o eliminarlas parcial o totalmente, en cualquier momento, a su discreción, sin previo aviso y sin dar explicaciones al usuario que las emite.
			</p>
			<p class="menuItem-text">
				LAGOBO se reserva el derecho de corregir en cualquier momento y en forma unilateral cualquier error u omisión en cualquier Contenido publicado en el www.serviciosoportunidades.com .
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Las siguientes actividades no se encuentran permitidas sobre el Sitio Web www.serviciosoportunidades.com:
			</p>
			<p class="menuItem-text">
				Anidar páginas del Sitio Web dentro de “frames” de Sitios externos.
			</p>
			<p class="menuItem-text">
				Utilizar “spiders”, “site copiers” o cualquier otro dispositivo, programa, algoritmo o método para acceder, adquirir, copiar o monitorear cualquier parte o contenido de www.serviciosoportunidades.com.
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Revisar o escanear el Sitio Web, servidores o redes de www.serviciosoportunidades.com, en busca vulnerabilidades de seguridad.
			</p>
			<p class="menuItem-text">
				Hacer “look-up”, “trace” o “sniffer” a la información transmitida desde o hacia cualquier usuario del Sitio Web.
			</p>
			<p class="menuItem-text">
				Hacer intentos desproporcionados de utilización del Sitio Web, los servidores o las redes de Lagobo Distribuciones S.A que puedan derivar en la negación del Servicio.
			</p>
			<p class="menuItem-text">
				Utilizar cualquier dispositivo, software o rutina para interferir con el adecuado funcionamiento del www.serviciosoportunidades.com o sus transacciones.
			</p>
			<p class="menuItem-text">
				Intentar manipular cualquier información transmitida hacia o desde el www.serviciosoportunidades.com para suplantar a otra persona o a www.serviciosoportunidades.com
			</p>
			<p class="menuItem-text">
			...
			<p class="menuItem-text">
				Después de realizar el retracto, LABOGO tendrá máximo 48 horas hábiles para enviar la guía de logística inversa para la devolución de producto, si este no se envía dentro de los primeros 5 días hábiles después de enviada la guía se entenderá que el cliente desea cancelar el retracto.
			</p>
